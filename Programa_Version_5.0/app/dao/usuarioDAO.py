...
class UsuarioDAO:
    ...
    def obtener_id_usuario(id_usuario):
        ...
        return Usuario(fila[0], fila[1], fila[2])
    ...
    def imprimir_usuarios():
        ...
        print('-' * 70)
        for u in fila:
            print(f' {u.id_usuario:<5} {u.nombre_usuario:<25} {u.rol_usuario:<25}')
            print('-' * 70)
    ...
    def comparar_usuario(usuario):
        ...
        if bcrypt.checkpw(usuario[1].encode('utf-8'), fila.contrasena_usuario.encode('utf-8')):
            usuario = (fila.nombre_usuario, fila.contrasena_usuario, fila.rol_usuario)
